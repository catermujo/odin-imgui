            ...
            if pcmd.UserCallback != nil {
                ...
                if is_new {
                    bind_group := CreateImageBindGroup(
                        ...
                        cast(wgpu.TextureView)cast(uintptr)tex_id,
                    )
                    val^ = bind_group
                }
...
CreateFontsTexture :: proc() {
    ...
    bd.renderResources.fontTextureView = wgpu.TextureCreateView(
        ...
        &{format = .RGBA8Unorm, dimension = ._2D, mipLevelCount = 1, arrayLayerCount = 1, aspect = .All},
    )
        ...
        &{
            ...
            fragment = &{
                ...
                targets = &wgpu.ColorTargetState {
                    ...
                    blend = &{alpha = {.Add, .One, .OneMinusSrcAlpha}, color = {.Add, .SrcAlpha, .OneMinusSrcAlpha}},
                    writeMask = wgpu.ColorWriteMaskFlags_All,
                },
            },
            primitive = {topology = .TriangleList, stripIndexFormat = .Undefined, frontFace = .CW, cullMode = .None},
